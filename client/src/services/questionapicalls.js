...
export const loadQuestionsByUid = (id) => {
  return fetch(`${process.env.REACT_APP_BACKEND}/questions/${id}`, {
    method: "GET",
  })
    .then((res) => {
      return res.json();
...
export const questionById = (id) => {
  return fetch(`${process.env.REACT_APP_BACKEND}/question/${id}`, {
    method: "GET",
  })
    .then((response) => {
...
export const searchQuestion = (question) => {
  return fetch(
    `${process.env.REACT_APP_BACKEND}/search/questions/?q=${question}`,
    { method: "GET" }
  )
    .then((response) => {
      return response.json();
...
export const answersByQuestionId = (id) => {
  return fetch(`${process.env.REACT_APP_BACKEND}/answers/${id}`, {
    method: "GET",
  })
    .then((response) => {
      return response.json();
...
export const updatequestion = (questionId, authorId, question, token) => {
  return fetch(
    `${process.env.REACT_APP_BACKEND}/question/${questionId}/${authorId}`,
    {
      method: "PUT",
      headers: {
        Accept: "application/json",
